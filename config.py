...
PCA9685_I2C_ADDR = 0x50     #I2C address, use i2cdetect to validate this number
PCA9685_I2C_BUSNUM = 2   #None will auto detect, which is fine on the pi. But other platforms should specify the bus num.
...
DRIVE_TRAIN_TYPE = "MOCK" # SERVO_ESC|DC_STEER_THROTTLE|DC_TWO_WHEEL|SERVO_HBRIDGE_PWM
